...
The CARE Principles for Indigenous Data Governance, defined more recently [@carroll_care_2020], emphasize ethical and responsible use of data:
...
These principles aim to protect Indigenous rights to self-determination and ensure data contributes positively to community development and innovation. Applying the CARE principles in archaeological research will strongly depend on whether and how the *indigenous peoples* associated to the material culture research are identified and defined by researchers.
...
* **Access to Source Code**: Users have access to the software's source code.  
...
For archaeologists, open-source tools can offer affordable solutions for data analysis, visualization, and data management, promoting a more inclusive research environment. Additionally, there is a growing community of archaeological software engineers that identify entirely with the open source principles [@batist_open_2024; noauthor_open_2015].
...
- Organizations:
  ...
  - [Wikimedia Foundation](https://wikimediafoundation.org/): A nonprofit organization focused on promoting the growth, development, and dissemination of free, multilingual content. It supports projects like Wikipedia, which provide free access to knowledge globally.  
  ...
  - [CAA Special Interest Group on Scientific Scripting Languages in Archaeology](https://sslarch.github.io/): group within the CAA that focusses on the application of Scripting Languages in archaeological research [@noauthor_home_nodate-2].
...
- Open Source Tools:  
  ...
  - [Arches](https://www.archesproject.org/): Arches is an open source software platform freely available for cultural heritage organizations to independently deploy to help them manage their cultural heritage data [@noauthor_arches_2015].
  - [OpenAtlas](https://openatlas.eu/): an open source database software developed especially to acquire, edit and manage research data from various fields of humanities like history, archaeology and cultural heritage as well as related scientific data [@noauthor_openatlas_nodate].  
