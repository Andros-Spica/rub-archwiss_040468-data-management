...
These principles aim to enhance the usefulness of digital assets by ensuring they can be easily located, understood, and utilized by others [@lamprecht_towards_2020; @wilkinson_fair_2016]. Applying FAIR principles in archaeology involves creating well-documented, datasets that other researchers can readily use and are ideally made available in open access [@hiebel_fair_2021;@lien-talks_how_2024;@nicholson_will_2023].

<!-- COMMENT
The FAIR principles do not require open access, on the contrary (see principle A2)! And there is good reason in archaeology to not have everything in open access. Readily to my mind comes protection from looters by not making site coordinates open access. 
-->
...
<!-- COMMENT
You might want to avoid Google Services because their use requires setting up a cookie banner (I would extremely surprised if this does not apply to the link above given that even inclusion of fonts from GoogleFont must be undisclosed in a cookie banner according to a court decision several years ago)
--> 
...
These principles aim to protect Indigenous rights to self-determination and ensure data contributes positively to community development and innovation. Applying the CARE principles in archaeological research will strongly depend on whether and how researchers identify and define the *indigenous peoples* associated with material culture research.

<!-- COMMENT
"Indigenous" is clearly defined and does not include all groups. For this reason, the TK (traditional knowledge) labels were conceptualised. I am not sure though if this level of detail is necessary here. 
--> 
...
<!-- COMMENT
What else is Javascript then a web development language? 
-->
